const Logo = () => {
  return (
    <div className="flex items-center pr-[32px] pl-[8px] gap-1">
      <svg
        width="36"
        height="36"
        viewBox="0 0 36 36"
      ...
      >
        ...
        <path
          d="M25.0329 5.33373C26.8032 6.31667 28.3478 7.65979 29.567 9.27643C30.7863 10.8931 31.6531 12.7473 32.1115 14.7196L18 18L25.0329 5.33373Z"
          stroke="#FFB74B"
          strokeWidth="12.7317"
          mask="url(#path-2-inside-1_436_4320)"
        ></path>
      </svg>
